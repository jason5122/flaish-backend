...
export const articles: articleType[] = [
  {
    ...
    description:
      "Introducing Supabase: The open-source Firebase alternative that’s easier to use and more scalable.",
    categories: [
    ...
    content: (
      <>
        ...
        <p className={styles.p}>
          Supabase is an open-source Firebase alternative that’s easier to use and more scalable. It's built on top of PostgreSQL and provides a suite of tools to help you build applications faster.
        </p>
      </>
    ),
  },
